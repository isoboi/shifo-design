        ...
        <div className="grid grid-cols-8 min-h-full">
          ...
          {displayDays.map((date, dayIndex) => (
            <div key={dayIndex} className="border-r border-gray-200 last:border-r-0">
              {viewMode === 'day' ? (
                // Day View: показываем до 4 записей с разными статусами
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative h-full">
                        {visibleAppointments.map((appointment, aptIndex) => {
                          ...
                          return (
                            <div
                              ...
                              className={`
                                absolute left-0 right-0 rounded border-l-2 px-1 cursor-pointer
                        ...
                        {hasMore && (
                          <div
                            className="absolute bottom-0 right-0 bg-gray-700 text-white text-xs px-1 rounded-tl"
                            style={{ fontSize: '8px' }}
                          >
